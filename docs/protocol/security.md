...
| :--- | :--- | :--- |
| **Confidentiality** | The adversary cannot read message content. | End-to-End Encryption (**ChaCha20-Poly1305**) |
| **Integrity** | Message tampering is detected. | Authenticated Encryption (**Poly1305 tag**) |
